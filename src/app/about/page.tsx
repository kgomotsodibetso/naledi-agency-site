      ...
      <main className="animate-fade-in-up">
        <div className="container mx-auto px-6 py-20">
            <div className="text-center mb-16">
                <h1 className="text-4xl md:text-5xl font-sans font-bold text-primary">Our Story</h1>
                <p className="font-handwriting text-accent text-4xl mt-2">More than a consultancy, we're your partner in growth.</p>
            </div>
            <div className="grid md:grid-cols-2 gap-16 items-center">
                ...
                <div>
                    <h2 className="text-3xl font-sans font-bold text-primary mb-4">From a Spark to a Star</h2>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-start gap-4">
                            <StarIcon className="w-6 h-6 text-secondary mt-1 flex-shrink-0" />
                            <div>
                                <h3 className="font-bold text-primary text-xl">Our Vision</h3>
                                <p className="text-muted-foreground">To be the leading launchpad for emerging brands in the digital space.</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4">
                            <StarIcon className="w-6 h-6 text-secondary mt-1 flex-shrink-0" />
                            <div>
                                <h3 className="font-bold text-primary text-xl">Our Values</h3>
                                <p className="text-muted-foreground">Creativity, Clarity, Partnership, and Optimism.</p>
                            </div>
                        </div>
                    </div>
                </div>
