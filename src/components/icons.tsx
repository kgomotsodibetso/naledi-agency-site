...
export const StarIcon = ({ className }: { className?: string }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 17.27l-5.18 3.73l1.4-6.04L2 9.27l6.16-.54L12 3l2.84 5.73l6.16.54l-6.22 5.7l1.4 6.04z" />
  </svg>
);
...
export const FacebookIcon = ({ className = "h-6 w-6" }: { className?: string }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.879V14.89h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v7.022A9.995 9.995 0 0022 12z"></path></svg>
);

export const InstagramIcon = ({ className = "h-6 w-6" }: { className?: string }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.85s-.011 3.584-.069 4.85c-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07s-3.584-.012-4.85-.07c-3.252-.148-4.771-1.691-4.919-4.919-.058-1.265-.069-1.645-.069-4.85s.011-3.584.069-4.85c.149-3.225 1.664-4.771 4.919-4.919C8.416 2.175 8.796 2.163 12 2.163zm0 1.441c-3.116 0-3.483.011-4.71.069-2.734.124-3.951 1.344-4.075 4.075-.058 1.226-.069 1.593-.069 4.71s.011 3.483.069 4.71c.124 2.734 1.341 3.951 4.075 4.075 1.227.058 1.594.069 4.71.069s3.483-.011 4.71-.069c2.734-.124 3.951-1.344 4.075-4.075.058-1.226.069-1.593.069-4.71s-.011-3.483-.069-4.71c-.124-2.734-1.341-3.951-4.075-4.075-1.227-.058-1.594-.069-4.71-.069zM12 6.883a5.117 5.117 0 100 10.234 5.117 5.117 0 000-10.234zm0 8.332a3.215 3.215 0 110-6.43 3.215 3.215 0 010 6.43zm6.406-8.232a1.2 1.2 0 100-2.4 1.2 1.2 0 000 2.4z"></path></svg>
);
