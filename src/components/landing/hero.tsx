  ...
  return (
    <section className="bg-midnight-blue text-white py-20 md:py-32 relative overflow-hidden">
      ...
      <div className="section-container text-center relative z-10">
        <h1 className="text-4xl md:text-6xl font-sans font-extrabold leading-tight mb-4 opacity-0 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>The Home of Brand Builders</h1>
        <p className="font-handwriting text-sunrise-yellow text-4xl md:text-5xl mb-6 opacity-0 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>From nothing, to something, to something big.</p>
        <p className="max-w-2xl mx-auto text-lg md:text-xl font-body mb-8 opacity-0 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
          We help small businesses, entrepreneurs, and startups build unforgettable brands that shine bright.
        </p>
