                        ...
                        blogPostsData.slice(0, 3).map((post) => (
                            <div key={post.id} className="bg-white rounded-lg shadow-lg overflow-hidden group">
                                ...
                                <div className="p-6">
                                    ...
                                    <h3 className="text-xl font-sans font-bold text-midnight-blue mt-1 mb-3">{post.title}</h3>
                                    <Link href="/blog" className="font-bold text-midnight-blue hover:text-golden-ochre transition-colors">
                                      Read More &rarr;
                                    </Link>
                                </div>
                            </div>
